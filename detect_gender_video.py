...
def detect_and_predict_gender(frame, faceNet, genderNet, minConf=0.5):
	...
	for i in range(0, detections.shape[2]):
		...
		if confidence > minConf:
			...
			# bounding box location along with the gender prediction,
...
while True:
	...
	# predict the gender
	results = detect_and_predict_gender(frame, faceNet, genderNet,
